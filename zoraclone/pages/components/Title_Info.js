...
function Title_Info() {
  return (
    ...
    <button class="border-2 ml-36 pr-2 mt-6 p-3 text-xl rounded-full bg-white border-slate-500 flex ">
      <script src="https://code.iconify.design/2/2.1.2/iconify.min.js"></script><span class="iconify mt-1 ml-1 mr-2 text-lg h-7 w-7" data-icon="emojione-v1:video-game"></span>COOL GAME</button>
