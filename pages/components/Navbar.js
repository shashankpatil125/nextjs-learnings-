    ...
    <div>
      <ul id="nav" className=" flex w-full bg-slate-500 fixed h-16 ">
        ...
        <div className='lg:hidden  md:hidden'>
          <button id="dropdownButton" data-dropdown-toggle="dropdown"  className="mt-3 ml-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 lg:hidden md-hidden sm-hidden" type="button" onClick={drop} >
