...
function Details() {
  ...
  return (
    <div class="text-center  bg-slate-300 p-8">
      
      <button onClick={enterd} class= " text-right my-2 bg-neutral-900 hover:bg-neutral-700 text-white font-bold py-2 px-4 border-b-4 border-black hover:border-blue-500 rounded">LOG IN/SIGN UP</button>

      <div id="myModal" class={usedisplay ? "" : "hidden" + " overflow-auto"}>
        <div class="">
          <div class="text-center my-20">
            <div class="border-2 border-slate-600 rounded-lg w-80 inline-block align-middle bg-white hover:shadow-2xl">
              <h1 class="text-center text-3xl">ENTER FOLLOWING DETAILS</h1>
