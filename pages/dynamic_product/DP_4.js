...
function Dp_4() {
  return (
    <div>
      ...
      <div className='flex'>
      <div>
        <img className="object-center p-10 pt-24 " src="https://m.media-amazon.com/images/I/71h7F81EBoS._AC_UY327_FMwebp_QL65_.jpg" alt="Girl in a jacket" width="500" height="600"></img>
